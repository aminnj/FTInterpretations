...
#########################################################################
#
# Additions for pseudoscalar mediated DM
#
#########################################################################
...
WPhiee  = Parameter(name = 'WPhiee',
               nature = 'internal',
               type = 'real',
               value = '(re(((gqq**2)*(Me**2)*(Mphi)/(8*cmath.pi*vev**2))*cmath.sqrt(1-(4*Me**2/Mphi**2))))',
               texname = '\\text{WPhiee}')

WPhimm  = Parameter(name = 'WPhimm',
               nature = 'internal',
               type = 'real',
               value = '(re(((gqq**2)*(MM**2)*(Mphi)/(8*cmath.pi*vev**2))*cmath.sqrt(1-(4*MM**2/Mphi**2))))',
               texname = '\\text{WPhimm}')

WPhitata  = Parameter(name = 'WPhitata',
               nature = 'internal',
               type = 'real',
               value = '(re(((gqq**2)*(MTA**2)*(Mphi)/(8*cmath.pi*vev**2))*cmath.sqrt(1-(4*MTA**2/Mphi**2))))',
               texname = '\\text{WPhitata}')

WPhiuu  = Parameter(name = 'WPhiuu',
               nature = 'internal',
               type = 'real',
               value = '(3*re(((gqq**2)*(MU**2)*(Mphi)/(8*cmath.pi*vev**2))*cmath.sqrt(1-(4*MU**2/Mphi**2))))',
               texname = '\\text{WPhiuu}')

WPhidd  = Parameter(name = 'WPhidd',
               nature = 'internal',
               type = 'real',
               value = '(3*re(((gqq**2)*(MD**2)*(Mphi)/(8*cmath.pi*vev**2))*cmath.sqrt(1-(4*MD**2/Mphi**2))))',
               texname = '\\text{WPhidd}')

WPhicc  = Parameter(name = 'WPhicc',
               nature = 'internal',
               type = 'real',
               value = '(3*re(((gqq**2)*(MC**2)*(Mphi)/(8*cmath.pi*vev**2))*cmath.sqrt(1-(4*MC**2/Mphi**2))))',
               texname = '\\text{WPhicc}')

WPhiss  = Parameter(name = 'WPhiss',
               nature = 'internal',
               type = 'real',
               value = '(3*re(((gqq**2)*(MS**2)*(Mphi)/(8*cmath.pi*vev**2))*cmath.sqrt(1-(4*MS**2/Mphi**2))))',
               texname = '\\text{WPhiss}')

WPhibb  = Parameter(name = 'WPhibb',
               nature = 'internal',
               type = 'real',
               value = '(3*re(((gqq**2)*(MB**2)*(Mphi)/(8*cmath.pi*vev**2))*cmath.sqrt(1-(4*MB**2/Mphi**2))))',
               texname = '\\text{WPhibb}')

WPhitt  = Parameter(name = 'WPhitt',
               nature = 'internal',
               type = 'real',
               value = '(3*re(((gqq**2)*(MT**2)*(Mphi)/(8*cmath.pi*(vev**2)))*cmath.sqrt(1-(4*(MT**2)/(Mphi**2)))))',
               texname = '\\text{WPhitt}')
...
WPhiDM  = Parameter(name = 'WPhiDM',
               nature = 'internal',
               type = 'real',
               value = '(re(((gDM**2)*(Mphi)/(8*cmath.pi))*cmath.sqrt(1-(4*(Mchi**2)/(Mphi**2)))))',
               texname = '\\text{WPhiDM}')
