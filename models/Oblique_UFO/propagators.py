...
S = Propagator(name = "S",
               ...
               # numerator = "complex(0,1)*(1-hhat)*(1-hhat)*(1-(hhat/(Mass(id)*Mass(id)))*(P('mu', id) * P('mu', id) - Mass(id) * Mass(id)))",
               numerator = "(1-hhat)*(1-hhat)*(1-(hhat/(Mass(id)*Mass(id)))*(P('mu', id) * P('mu', id) - Mass(id) * Mass(id)))",
