...
# with command line options: Configuration/GenProduction/python/TOP-RunIIFall18wmLHEGS-00125-fragment.py --filein file:events.lhe --fileout file:output_gensim.root --mc --eventcontent RAWSIM,LHE --datatier GEN-SIM,LHE --conditions 102X_upgrade2018_realistic_v11 --beamspot Realistic25ns13TeVEarly2018Collision --step LHE,GEN,SIM --nThreads 1 --geometry DB:Extended --era Run2_2018 --python_filename pset_gensim.py --no_exec --customise Configuration/DataProcessing/Utils.addMonitoring --customise_commands process.RandomNumberGeneratorService.externalLHEProducer.initialSeed=int(1555458639%100) -n 20
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/TOP-RunIIFall18wmLHEGS-00125-fragment.py nevts:20'),
...
process.RandomNumberGeneratorService.externalLHEProducer.initialSeed=int(1555458639%100)
